                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    <Button variant="outline" asChild>
                      <Link href="/billing/subscriptions">View Details</Link>
                    </Button>
                    {currentSubscription.status === 'active' && (
                      <Button variant="outline" asChild>
                        <Link href="/billing/subscriptions/cancel">Cancel Subscription</Link>
                      </Button>
                    )}
                  </div>
                </div>
              ...
              : (
                  <div className="space-y-4">
                    ...
                    <Button variant="outline" className="w-full" asChild>
                      <Link href="/billing/payments">View All Payments</Link>
                    </Button>
                  </div>
                )}
        </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            ...
            {availableProducts.length > 3 && (
              <div className="mt-4">
                <Button variant="outline" className="w-full" asChild>
                  <Link href="/billing/plans">View All Plans</Link>
                </Button>
              </div>
            )}
          </CardContent>
