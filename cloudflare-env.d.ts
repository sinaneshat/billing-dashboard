/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 7d0481365ddf18738fdaab54e1d1363a)
...
declare namespace Cloudflare {
	interface Env {
		...
		NEXT_PUBLIC_APP_URL: "http://localhost:3000" | "https://billing-preview.roundtable.now" | "https://billing.roundtable.now";
		NEXT_PUBLIC_MAINTENANCE: "false";
		NEXT_PUBLIC_TURNSTILE_SITE_KEY: "0x4AAAAAAAnF8lAkO8_hM6w4" | "0x4AAAAAAAnF8lAkO8_hM6w5" | "0x4AAAAAAAnF8lAkO8_hM6w6";
		R2_PUBLIC_URL: "http://localhost:3000/uploads" | "https://billing-preview.roundtable.now/uploads" | "https://billing.roundtable.now/uploads";
		AWS_SES_REGION: "us-east-1";
		FROM_EMAIL: "noreply@localhost" | "noreply@roundtable.now";
		SES_REPLY_TO_EMAIL: "noreply@localhost" | "noreply@roundtable.now" | "support@roundtable.now";
		SES_VERIFIED_EMAIL: "noreply@localhost" | "noreply@roundtable.now";
		WEBHOOK_URL: "http://localhost:3000/api/webhooks/zarinpal" | "https://billing-preview.roundtable.now/api/webhooks/zarinpal" | "https://billing.roundtable.now/api/webhooks/zarinpal";
		EXTERNAL_WEBHOOK_URL: "http://localhost:3000/api/webhooks/external" | "https://billing-preview.roundtable.now/api/webhooks/external" | "https://billing.roundtable.now/api/webhooks/external";
		ZARINPAL_DEFAULT_CONTRACT_DURATION_DAYS: "365";
		ZARINPAL_DEFAULT_MAX_DAILY_COUNT: "5" | "25";
		ZARINPAL_DEFAULT_MAX_MONTHLY_COUNT: "50" | "750";
		ZARINPAL_DEFAULT_MAX_AMOUNT: "10000000" | "100000000";
		ZARINPAL_PAYMAN_CALLBACK_URL: "http://localhost:3000/api/webhooks/zarinpal/payman" | "https://billing-preview.roundtable.now/api/webhooks/zarinpal/payman" | "https://billing.roundtable.now/api/webhooks/zarinpal/payman";
		CARD_VERIFICATION_AMOUNT: "1000";
		CARD_VERIFICATION_DESCRIPTION: "Roundtable billing verification (local)" | "Roundtable billing verification";
		ROUNDTABLE_APP_URL: "https://roundtable.now";
		OPEN_NEXT_DEBUG: "true" | "false";
		...
		ROUNDTABLE_SUPABASE_URL: string;
		ROUNDTABLE_SUPABASE_SERVICE_KEY: string;
