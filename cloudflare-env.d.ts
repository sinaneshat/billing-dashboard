/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 857311411092e530601ce6225c0d7bf7)
...
declare namespace Cloudflare {
	interface Env {
		...
		SUPABASE_URL: "https://zrldjcsfobgfagijwkwk.supabase.co";
		NODE_ENV: string;
		NEXTJS_ENV: string;
		NODE_VERSION: string;
		PNPM_VERSION: string;
		...
		NEXT_PUBLIC_ROUNDTABLE_APP_URL: string;
		...
		NEXT_PUBLIC_ZARINPAL_DEFAULT_CONTRACT_DURATION_DAYS: string;
		NEXT_PUBLIC_ZARINPAL_DEFAULT_MAX_DAILY_COUNT: string;
		NEXT_PUBLIC_ZARINPAL_DEFAULT_MAX_MONTHLY_COUNT: string;
		NEXT_PUBLIC_ZARINPAL_DEFAULT_MAX_AMOUNT: string;
		NEXT_PUBLIC_ZARINPAL_PAYMAN_CALLBACK_URL: string;
		NEXT_PUBLIC_CARD_VERIFICATION_AMOUNT: string;
		NEXT_PUBLIC_CARD_VERIFICATION_DESCRIPTION: string;
		...
		NEXT_PUBLIC_EXTERNAL_WEBHOOK_URL: string;
