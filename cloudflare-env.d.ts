/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 1ce9a669b24a2c9f61311ec652a75b29)
// Runtime types generated with workerd@1.20250813.0 2024-12-30 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		PASS_CACHE: KVNamespace;
		QUOTA_CACHE: KVNamespace;
		NODE_ENV: string;
		NEXTJS_ENV: string;
		NODE_VERSION: string;
		PNPM_VERSION: string;
		...
		AMAZON_SES_PUBLIC_KEY: string;
		AMAZON_SES_SECRET: string;
		...
		PASS_PRIVATE_KEY: string;
		WWDR_CERTIFICATE: string;
		PASS_SECRET: string;
		GOOGLE_PAY_ISSUER_ID: string;
		GOOGLE_PAY_SERVICE_ACCOUNT_EMAIL: string;
		GOOGLE_PAY_SERVICE_ACCOUNT_KEY: string;
		FIREBASE_ADMIN_SDK_CONFIG: string;
		TWILIO_ACCOUNT_SID: string;
		TWILIO_AUTH_TOKEN: string;
		TWILIO_PHONE_NUMBER: string;
		OPEN_NEXT_DEBUG: string;
		WRANGLER_LOG: string;
		WRANGLER_DEBUG_ENABLE: string;
		DEBUG: string;
		NEXT_DEBUG: string;
		NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
		UPLOADS_R2_BUCKET: R2Bucket;
		PASSES_R2_BUCKET: R2Bucket;
		DB: D1Database;
		WORKER_SELF_REFERENCE: Fetcher /* billing-dashboard-local */;
		ASSETS: Fetcher;
	}
}
