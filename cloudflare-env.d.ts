/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 706c0be3f0077ba6912962b325a67df0)
// Runtime types generated with workerd@1.20250813.0 2025-03-25 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		NEXT_PUBLIC_API_URL: "http://localhost:3000/api/v1" | "https://billing-preview.roundtable.now/api/v1" | "https://billing.roundtable.now/api/v1";
		NEXT_PUBLIC_APP_NAME: "Roundtable Billing Dashboard";
		...
		NEXT_PUBLIC_R2_PUBLIC_URL: "http://localhost:3000/uploads" | "https://billing-preview.roundtable.now/uploads" | "https://billing.roundtable.now/uploads";
		NEXT_PUBLIC_WEBHOOK_URL: "http://localhost:3000/api/webhooks/zarinpal" | "https://billing-preview.roundtable.now/api/webhooks/zarinpal" | "https://billing.roundtable.now/api/webhooks/zarinpal";
		...
		NEXT_PUBLIC_ZARINPAL_PAYMAN_CALLBACK_URL: "http://localhost:3000/api/webhooks/zarinpal/payman" | "https://billing-preview.roundtable.now/api/webhooks/zarinpal/payman" | "https://billing.roundtable.now/api/webhooks/zarinpal/payman";
		NEXT_PUBLIC_CARD_VERIFICATION_AMOUNT: "1000";
		NEXT_PUBLIC_CARD_VERIFICATION_DESCRIPTION: "Card verification (local)" | "Card verification";
		...
		DB: D1Database;
		WORKER_SELF_REFERENCE: Fetcher /* billing-dashboard */;
		ASSETS: Fetcher;
	}
}
